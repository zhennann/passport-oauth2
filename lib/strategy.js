...
OAuth2Strategy.prototype.getOAuth = function(options) {
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  // oauth2
  const _oauth2 = this.getOAuth(options);
  ...
  var meta = {
    authorizationURL: _oauth2._authorizeUrl,
    tokenURL: _oauth2._accessTokenUrl,
    clientID: _oauth2._clientId
  }
  ...
  if (req.query && req.query.code) {
    function loaded(err, ok, state) {
      ...
      _oauth2.getOAuthAccessToken(code, params,
    ...
    if (state) {
      ...
      var parsed = url.parse(_oauth2._authorizeUrl, true);
      utils.merge(parsed.query, params);
      parsed.query['client_id'] = _oauth2._clientId;
